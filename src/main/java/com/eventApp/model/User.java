...
/**
 * JPA Entity representing a user in the event application.
 * Contains basic user details such as id, name, email, password, and role.
 * 
 * This is the Spring Boot/JPA version of the original User class.
 * Changes from original:
 * - Added JPA annotations for database mapping
 * - Added validation annotations
 * - Added default constructor for JPA
 * - Following Spring Boot naming conventions
 */
@Entity
@Table(name = "users")
